...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/ygrletxd/settings/api) and create a token with read rights.
